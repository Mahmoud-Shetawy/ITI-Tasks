...
int main()
{
    ...
    ptrarr=a; //F
    ptrarr=&a;//F  LVALUE
    ptrarr[0]=a; //F //logic Error cause Runtime error
    ptrarr[0]=&a; //T
    ptrarr[1]=&b; //T
    ptrarr[2]=&c; //T
    ptrarr[3]=&d; //T
...
int main()
{
    ...
    double y=33;   //8B   //4Billion

    //casting
    //is done implicitly --> implicit cast is commonly used in c
    //safe casting
    //y=x;

    //casting
    //is done explicitly //useless --> compiler do it automatically
    //safe casting
    //y=(double)x;
    ...
    //explicit cast //useless --> compiler do it automatically
    //unsafe casting
    //x=(int)y;

    printf("%d",x);  //Rubbish value
    printf("%lf",y); //4Billion
...
int main()
{
    ...
    //and return address of fst element 
...
//////////////////////////////////////////
//fullfill places with integer values
int main()
{
    int *ptr= (int*) malloc(16);
...
int main()
{
    ...
    //v1
    //Very dangerous
    //move and change ptr value in memory 
    *ptr=10;
    ptr++;
    *ptr=20;
    ptr++;
...
///////////////////////////
///read data from yser in runtime
int main()
{
    int* ptr= (int*) malloc(20);
    
    ///read into fst element ONLY
    scanf("%d",ptr); //T
    scanf("%d",ptr[0]); //F
    scanf("%d",&ptr[0]); //T
    scanf("%d",&ptr); //BIG FALSE
...
////////////////////////////////////////
//Define size correctly in runtime
//plz enter array size
//10

//OR

//plz enter array size in bytes
//40
...
int main()
{
    ...
    int* ptr= /*(int*)*/ malloc(_size * sizeof(int));//40B
    ///at this point
    ///we can consider ptr as --> int ptr[10]
...
int main()
{
    ...
    ptrArr[0]=malloc(mySize*sizeof(int));
    ptrArr[1]=(int *)malloc(mySize*sizeof(int));
    ptrArr[2]=malloc(mySize*sizeof(int));
...
// for pointer to integer read and write
